    ...
    <div class="h-screen flex">
        <div class="flex w-1/2 bg-gradient-to-tr from-blue-400 to-green-400 i justify-around items-center">
            <div>
                ...
                <button type="submit"
                    class="block w-28 bg-white text-indigo-800 mt-6 py-2 rounded-2xl font-bold mb-2">{{ __('Ver website') }}</button>
            </div>
        </div>
        <div class="flex w-1/2 justify-center items-center bg-white">
            <form method="POST" action="{{ route('login') }}">
                ...
                <button type="submit"
                    class="block w-full bg-blue-400 mt-4 py-2 rounded-2xl text-white font-semibold mb-2">{{ __('Entrar') }}</button>
                ...
                <div class="flex items-center justify-end mt-4">
                    ...
                    @endif
                    <a class="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800 ms-3"
                        href="{{ route('register') }}">
                        {{ __('Criar Conta') }}
                    </a>
                </div>
