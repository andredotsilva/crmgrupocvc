<aside
    class="flex flex-col px-5 py-8 h-auto overflow-y-auto bg-white rounded-2xl border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700">
            ...
            <aside
                                ...
                                <x-slot name="trigger">
                                    <button
                                        ...
                                        <div class="flex flex-col">
                                            ...
                                            <p
                                                class="mt-4 rounded-md bg-blue-50 px-2 py-1 text-xs font-medium text-blue-700 ring-1 ring-inset ring-blue-700/10">
                                                {{ Auth::user()->roles()->pluck('title')->first() }}</p>
                                        </div>
                                        <div class="ml-1">
                ...
                <div class="flex flex-col justify-between flex-1 mt-6">
                    <nav class="-mx-3 space-y-6 ">
                        ...
                        <div class="space-y-3 ">
                            <label
                                class="px-3 text-xs text-gray-500 uppercase dark:text-gray-400">Customization</label>
