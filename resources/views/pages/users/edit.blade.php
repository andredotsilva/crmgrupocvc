<x-app-layout>
    <x-slot name="header" class="pt-8">
        ...
        <div class="flex items-end justify-between">
            <h4 class="mr-4 text-xl	dark:text-gray-200">{{ __(' Editar Utilizador - ') }}{{ $user->name }}</h4>
            <a href="{{ url()->previous() }}">
                <button
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 mb-4">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="gap-x-6 gap-y-8 sm:grid-cols-6 bg-white  p-6 rounded-2xl dark:bg-gray-800">
                    ...
                    <div class="max-w-md mx-auto bg-white dark:bg-gray-800 rounded-md p-6">
                        <h2 class="text-lg font-semibold mb-4 dark:text-gray-200">Editar Utilizador</h2>
