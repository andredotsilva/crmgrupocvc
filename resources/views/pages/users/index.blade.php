                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="container mx-auto p-4">
                        <div class="flex items-stretch justify-start mb-4">
                            ...
                            <div class="absolute top-0 left-0 flex items-center h-full ml-4">
                              ...
                              >
                                <path
                                  ...
                                  stroke-width="2"
                                  d="M15.5 15.5l5.085 5.086M8.5 15.5a7 7 0 1 1 7-7 7 7 0 0 1-7 7z"
                                ></path>
                              </svg>
                            </div>
                          </div>
                          <div>
                            <div class="relative">
                                <select class="py-2 pl-4 pr-8 rounded-lg border border-gray-300 focus:outline-none focus:border-blue-500">
                        ...
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700 pb-4">
                          <thead>
                            <tr>
                              <th class="py-2 px-4 bg-gray-100 border-b border-gray-100 font-bold  text-md text-gray-700 text-left">
                                {{ 'Nome' }}
                              </th>
                              <th class="py-2 px-4 bg-gray-100 border-b border-gray-100 font-bold  text-md text-gray-700 text-left">
                                {{ 'Email' }}
                              ...
                              <th class="py-2 px-4 bg-gray-100 border-b border-gray-100 font-bold  text-md text-gray-700 text-right">
