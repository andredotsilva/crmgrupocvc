<x-app-layout>
    <x-slot name="header">
        <nav class="flex items-center space-x-2 text-sm text-gray-500 dark:text-gray-300 py-2">
            ...
            <span>/</span>
            <span class="text-gray-600 dark:text-gray-200">{{ __('Provedores') }}</span>
        </nav>
                        ...
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            <thead class="bg-gray-50 dark:bg-gray-800">
                                <tr>
                                    ...
                                    <th class="py-3.5 px-4 text-sm font-normal text-left text-gray-500 dark:text-gray-400">Acrónimo</th>
                                    <th class="py-3.5 px-4 text-sm font-normal text-left text-gray-500 dark:text-gray-400">Nome</th>
                                    <th class="relative py-3.5 px-4"><span class="sr-only">Ações</span></th>
                                </tr>
                            </thead>
