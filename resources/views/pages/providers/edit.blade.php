            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="gap-x-6 gap-y-8 sm:grid-cols-6 px-6 pb-2 pt-4 rounded-2xl bg-white dark:bg-gray-800">
                    <div class="max-w-md mx-auto bg-white shadow-md rounded-md p-6">
                        <h2 class="text-lg font-semibold mb-4">Editar Provedor</h2>
                        <form action="{{ route('providers.update', $providers->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="mb-4">
                                <label class="block text-gray-700 font-bold mb-2" for="name">Acronimo:</label>
                                <input type="text" id="name" name="acronym" value="{{ $providers->acronym }}"
                                    class="border border-gray-300 rounded-md px-3 py-2 w-full">
                            </div>
                            <div class="mb-4">
                                <label class="block text-gray-700 font-bold mb-2" for="text">Titulo:</label>
