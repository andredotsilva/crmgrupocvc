                    ...
                    <div class="container mx-auto p-4">
                            ...
                            <div class="flex items-stretch justify-start mb-4 flex-row gap-3">
                                <div class="relative mt-2 rounded-md shadow-sm">
                                    <input type="text" name="name"
                                        ...
                                        placeholder="Pesquisar Codigo Cae">
                                </div>
                            </div>
                        ...
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700 pb-4 ">
                            ...
                            <tbody>
                                ...
                                @foreach ($caes as $cae)
                                    <tr>
                                        <td class="py-2 px-4 border-b border-gray-600">{{ $cae->code }}</td>
                                        <td class="py-2 px-4 border-b border-gray-600">{{ $cae->title }}</td>
                                        

                                        <td class="py-2 px-4 border-b border-gray-600 text-right">
                                            <div class="flex items-stretch justify-end gap-x-6">
                                                <a href="{{ route('cae.edit', $cae->id) }}"
                                                ...
                                                <form action="{{ route('cae.destroy', $cae->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button
